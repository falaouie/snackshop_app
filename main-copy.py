...
class UserIDWindow(QWidget):
    ...
    def initUI(self):
        ...
        for text, row, col in buttons:
            ...
            button.setFixedSize(80, 50)  # Increased button height for better touch targets
        ...
        if self.sign_in_button:
            ...
            self.sign_in_button.setFixedSize(80, 50)  # Match the size of other buttons
    ...
    def check_sign_in_enable(self):
        if self.current_index == 4:
            ...
            self.sign_in_button.setStyleSheet("background-color: lightgreen; font-size: 12pt;") # Enabled color
        else:
            self.sign_in_button.setEnabled(False)
            self.sign_in_button.setStyleSheet("background-color: lightgray; font-size: 12pt;") # Disabled color
            self.sign_in_button.setFixedSize(80, 50)  # Match the size of other buttons
...
class PasswordWindow(QWidget):
    ...
    def initUI(self):
        ...
        password_layout.setHorizontalSpacing(15)  # Horizontal spacing between password buttons
        for i in range(4):
            btn = QPushButton(' ')
            btn.setFixedSize(60, 40)
            btn.setEnabled(False)
